...
//	 * onConnectionFailed() in LocationUpdateRemover and LocationUpdateRequester may call startResolutionForResult() to start an Activity
//	 * that handles Google Play services problems. The result of this call returns here, to onActivityResult.
//	 */
//	@Override
...
//
//	/*
//	 * Called by Location Services when the request to connect the client finishes successfully. At this point, you can request the current
