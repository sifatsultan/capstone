...
void setValues(int motorVal1, int motorVal2, int motorVal3, int motorVal4){
  ...
  Serial.println(motorVal3);
  Serial.println(motorVal4);
  if ((motorVal1 <= 900) && (motorVal1 >= 100) && (motorVal2 <= 900) && (motorVal2 >= 100) && (motorVal4 <= 900) && (motorVal4 >= 100)){
    ...
    Serial.print("Aileron was set to: ");
    Serial.println((int)(((motorVal1-100.0)/800.0)*180.0));
    // Elevation
    Elevation.write((int)(((motorVal2-100.0)/800.0)*180.0));
    Serial.print("Elevation was set to: ");
    Serial.println((int)(((motorVal2-100)/800)*180));
    // Thrust
    Thrust.write((int)(((motorVal3-100.0)/800.0)*180.0));
    Serial.print("Thrust was set to: ");
    Serial.println((int)(((motorVal3-100.0)/800.0)*180.0));
    // Rudder
    Rudder.write((int)(((motorVal4-100.0)/800.0)*180.0));
    Serial.print("Rudder was set to: ");
    Serial.println((int)(((motorVal4-100.0)/800.0)*180.0));
  }
  else{
