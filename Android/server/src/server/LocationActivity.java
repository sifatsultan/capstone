...
//	
//	
//	private Button getLocation ,startUpdates, stopUpdates, getAddress; 
//
//	@Override
...
//
//		/* begin_current_location */
//
//		// Get handles to the UI view objects
//		
////		private Button getLocation ,startUpdates, stopUpdates, getAddress;
//		getLocation = (Button)findViewById(R.id.btn_getLocation);
//		getAddress = (Button)findViewById(R.id.btn_getAddress);
//		startUpdates = (Button)findViewById(R.id.btn_startUpdates);
//		stopUpdates = (Button)findViewById(R.id.btn_stopUpdates);
//		
//				
////		mLatLng = (TextView) findViewById(R.id.tv_currentLatLng);
////		mAddress = (TextView) findViewById(R.id.tv_address);
////		mActivityIndicator = (ProgressBar) findViewById(R.id.pb_activityIndicator);
////		mConnectionState = (TextView) findViewById(R.id.tv_connectionState);
...
//
//				// Display the result
//				Toast.makeText(this, "State: Connected  Status:Resolved", Toast.LENGTH_SHORT).show();
//				// mConnectionState.(R.string.connected);
...
//
//				// Display the result
//				Toast.makeText(this, "State: Disconnected  Status:No Resolution", Toast.LENGTH_SHORT).show();
...
//			getLocation.setText(LocationUtils.getLatLng(this, currentLocation));
//		}
//	}
//
//	/**
...
//		getLocation.setText(LocationUtils.getLatLng(this, location));
